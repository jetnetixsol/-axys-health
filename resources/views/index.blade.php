...
<div class="page-content-wrapper indx">
    <div class="page-content">
                            ...
                            <ul class="docListWindow">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <!-- <img src="{{ asset('public/assets/img/doc/doc1.jpg') }}" alt="" width="40" height="40"> -->
        ...
        <script src="{{ asset('public/assets/bundles/chart-js/Chart.min.js') }}"></script>
        <script src="{{ asset('public/assets/bundles/chart-js/utils.js') }}"></script>
        <script src="{{ asset('public/assets/bundles/apexcharts/apexcharts.min.js') }}"></script>
        <!-- <script src="{{ asset('public/assets/data/apexcharts.data.js') }}"></script> -->

    ...
    <div class="page-wrapper">
        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.php">
                        <div class="lgo-img logo-default" style="background-image:url('<?= asset('public/assets/img/my-img/white-logo.png') ?>')"></div>
                        <div class="lgo-ico logo-icon" style="background-image:url('<?= asset('public/assets/img/my-img/color-icon.png') ?>')"></div>
                    </a>
                </div>
                <!-- logo end -->
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <div class="usr-ar">
                                    <div class="usr-dp" style="background-image: url('<?= asset('public/assets/img/my-img/usr.png') ?>')"></div>
                                </div>
                            </a>
                            ...
                            <li class="sidebar-user-panel">
                                <div class="sidebar-user">
                                    <div class="sidebar-user-picture">
                                        <div class="usr-bg">
                                            <div class="usr-img" style="background-image:url('<?= asset('public/assets/img/my-img/usr.png') ?>')"></div>
                                        </div>
                                    </div>

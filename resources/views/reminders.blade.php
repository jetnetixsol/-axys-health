...
@include('header')
	...
	<link rel="stylesheet" href="{{ asset('public/assets/bundles/flatpicker/css/flatpickr.min.css') }}" />
	<link href="{{ asset('public/assets/bundles/fullcalendar/packages/core/main.min.css') }}" rel='stylesheet' />
	<link href="{{ asset('public/assets/bundles/fullcalendar/packages/daygrid/main.min.css') }}" rel='stylesheet' />
	<link href="{{ asset('public/assets/bundles/fullcalendar/packages/timegrid/main.min.css') }}" rel='stylesheet' />
	...
	<script src="{{ asset('public/assets/bundles/fullcalendar/packages/core/main.min.js') }}"></script>
	<script src="{{ asset('public/assets/bundles/fullcalendar/packages/interaction/main.min.js') }}"></script>
	<script src="{{ asset('public/assets/bundles/fullcalendar/packages/daygrid/main.min.js') }}"></script>
	<script src="{{ asset('public/assets/bundles/fullcalendar/packages/timegrid/main.min.js') }}"></script>
	<script src="{{ asset('public/assets/data/calendar-data.js') }}"></script>
	<script>
		// var calendar;

...
<script src="{{ asset('public/assets/bundles/jquery-validation/js/jquery.validate.min.js') }}"></script>
<script src="{{ asset('public/assets/bundles/jquery-validation/js/additional-methods.min.js') }}"></script>

<script src="{{ asset('public/assets/bundles/flatpicker/js/flatpicker.min.js') }}"></script>
<script src="{{ asset('public/assets/data/date-time.init.js') }}"></script>

<script src="{{ asset('public/assets/data/form-validation.js') }}"></script>
@include('footer')

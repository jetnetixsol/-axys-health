...
<link rel="stylesheet" href="{{ asset('public/assets/css/tom-select.css') }}">
<link rel="stylesheet" href="{{ asset('public/assets/css/daterangepicker.css') }}">
<!-- data tables -->
<link href="{{ asset('public/assets/bundles/flatpicker/css/flatpickr.min.css') }}" rel="stylesheet">
...
<script src="{{ asset('public/assets/js/tom-select.complete.min.js') }}"></script>
<script src="{{ asset('public/assets/js/moment.min.js') }}"></script>
<script src="{{ asset('public/assets/js/daterangepicker.min.js') }}"></script>
<!-- data tables -->
<script src="{{ asset('public/assets/data/table-data.js') }}"></script>
<script src="{{ asset('public/assets/bundles/flatpicker/js/flatpicker.min.js') }}"></script>
<script src="{{ asset('public/assets/bundles/bootstrap-switch/js/bootstrap-switch.min.js') }}"></script>
<script src="{{ asset('public/assets/bundles/bootstrap-inputmask/bootstrap-inputmask.min.js') }}"></script>
<script>
	$(function() {
